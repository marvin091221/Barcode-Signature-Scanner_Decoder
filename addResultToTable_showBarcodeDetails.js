function addResultToTable(filename, result) {
    ...
    row.innerHTML = `
        ...
        <td class="px-6 py-4 whitespace-nowrap">
            ${result.barcodes.some(b => b.hasSignature) ? 
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-200">
                <thead class="bg-blue-300">
                    <tr>
                        <th class="px-4 py-2 border-b border-gray-200 text-left text-l font-large text-gray-800 uppercase tracking-wider">#</th>
                        <th class="px-4 py-2 border-b border-gray-200 text-left text-l font-large text-gray-800 uppercase tracking-wider">Barcode</th>
                        <th class="px-4 py-2 border-b border-gray-200 text-left text-l font-large text-gray-800 uppercase tracking-wider">Signature</th>
                        <th class="px-4 py-2 border-b border-gray-200 text-left text-l font-large text-gray-800 uppercase tracking-wider">Confidence</th>
                    </tr>
                </thead>
