...
<body class="bg-gray-100 min-h-screen p-4">
    <div class="container mx-auto bg-white p-6 rounded-lg shadow-lg max-w-6xl">
        ...
        <div class="flex flex-col items-center">
            ...
            <div id="dropZone" class="border-2 border-dashed border-gray-400 py-6 px-12 w-full text-center rounded-lg mb-4 hover:bg-gray-50 cursor-pointer transition-colors">
            ...
            <div class="overflow-x-auto mb-4">
                <table class="min-w-full bg-white border border-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 border-b border-gray-200 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">File</th>
                            <th class="px-6 py-3 border-b border-gray-200 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Barcodes Found</th>
                            <th class="px-6 py-3 border-b border-gray-200 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Signature</th>
                            ...
                            <th class="px-6 py-3 border-b border-gray-200 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Details</th>
                        </tr>
                    </thead>
